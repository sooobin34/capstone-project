...
# LOW / MID 경계 구간 보정을 위한
# 추가 분류 모델 학습 코드
#
# LOW 와 MID 데이터만 별도로 학습하여
# 경계 영역에서 발생하는 오분류를 줄이는 목적
#
# ResNet18 기반 전이학습 사용
#
# 저장 모델:
# models/water_classifier_low_mid_best.pth
#
# 최종 LOW-MID 경계 모델 성능:
# Test Accuracy: 100 %
# =========================================================
...
DATA_DIR = "../data_boundary_low_mid"
MODEL_SAVE_PATH = "models/water_classifier_low_mid_best.pth"
